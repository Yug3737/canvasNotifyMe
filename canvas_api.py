...
# precondition: given 2 strings one is due date of a HW and ther other is current time,
...
def get_hws_due(hw_dict: dict, current_time: str) -> dict:
    ...
    for hw, due_date in hw_dict.items():
        if due_date > current_time and \
        get_approximate_duedate_difference(due_date, current_time) > 13 and \
